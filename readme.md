...
* HashMapIndex не самый оптимальный вариант, так как search таски блокируют update таски и наоборот, можно разбить индекс на сегменты, для каждого документа создавать новый сегмент, а потом их мержить
* HashMapIndex занимает слишком много места
